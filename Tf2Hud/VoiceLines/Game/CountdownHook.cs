...
public sealed class CountdownHook : IDisposable
{
    ...
    private readonly CountdownState state;
    ...
    public CountdownHook(CountdownState state, Condition condition)
    {
        this.state = state;
    ...
    private void UpdateCountDown()
    {
        ...
        {
            if (countDownRunning) state.FireStopCountingDown(countDownPointerValue > 0.1f);
